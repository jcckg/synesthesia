...
inline ResourceData loadResource(int resourceId, LPCSTR resourceType = RT_RCDATA) {
...
inline std::vector<unsigned char> loadResourceAsVector(int resourceId, LPCSTR resourceType = RT_RCDATA) {
...
inline std::string loadResourceAsString(int resourceId, LPCSTR resourceType = RT_RCDATA) {
    ResourceData resource = loadResource(resourceId, resourceType);
...
inline std::string extractResourceToTemp(int resourceId, const std::string& filename, LPCSTR resourceType = RT_RCDATA) {
    ResourceData resource = loadResource(resourceId, resourceType);
